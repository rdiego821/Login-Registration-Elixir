defmodule MsLoginRegistrationE.Application do
  @moduledoc """
  MsLoginRegistrationE application
  """

  alias MsLoginRegistrationE.Infrastructure.EntryPoints.RestController
  alias MsLoginRegistrationE.Config.{AppConfig, ConfigHolder}
  ...
  def start(_type, [env]) do
    ...
    opts = [strategy: :one_for_one, name: MsLoginRegistrationE.Supervisor]
  ...
  defp with_plug_server(%AppConfig{enable_server: true, http_port: port}) do
    ...
    [{Plug.Cowboy, scheme: :http, plug: RestController, options: [port: port]}]
  end
