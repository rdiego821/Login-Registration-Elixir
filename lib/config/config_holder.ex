defmodule MsLoginRegistrationE.Config.ConfigHolder do
  use GenServer
  alias MsLoginRegistrationE.Config.AppConfig
  @table_name :ms_login_registration_e_config
  ...
  defp load_additional_properties(%AppConfig{} = config) do
    Application.get_env(:ms_login_registration_e, :config_loaders, [])
...
defmodule MsLoginRegistrationE.Config.ConfigHolder.PropertiesLoaderBehaviour do
  alias MsLoginRegistrationE.Config.AppConfig
