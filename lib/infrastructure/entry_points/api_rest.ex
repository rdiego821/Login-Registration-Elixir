defmodule MsLoginRegistrationE.Infrastructure.EntryPoint.ApiRest do
  @compile if Mix.env() == :test, do: :export_all
  @moduledoc """
  Access point to the rest exposed services
  """
  # alias MsLoginRegistrationE.Utils.DataTypeUtils
  require Logger
  use Plug.Router
  use Timex
  ...
  plug(Plug.Telemetry, event_prefix: [:ms_login_registration_e, :plug])
  plug(:dispatch)
  ...
  forward(
    ...
    init_opts:
      PlugCheckup.Options.new(
        json_encoder: Jason,
        checks: MsLoginRegistrationE.Infrastructure.EntryPoint.HealthCheck.checks()
      )
  )
