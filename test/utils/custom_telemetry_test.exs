defmodule MsLoginRegistrationE.Utils.CustomTelemetryTest do
  alias MsLoginRegistrationE.Utils.CustomTelemetry
  use ExUnit.Case
  ...
  test "execute_custom_event emits the event with correct metric, value, and metadata" do
    ...
    value = 200
    metadata = %{source: "api"}
    service_name = "ms_login_registration_e_test"
  ...
  test "handle_custom_event adds service name to metadata" do
    ...
    Application.put_env(:ms_login_registration_e, :service_name, service_name)
  ...
  test "execute_custom_event emits the correct event with default metadata" do
    metric = [:custom, :event]
    value = 200
    expected_metadata = %{service: "ms_login_registration_e_test"}
